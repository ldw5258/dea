...
;; Time-stamp: <2011-09-30 18:44:51 Friday by ldw>

(defconst my-emacs-path "/home/ldw/dea/" "我的emacs相关配置文件的路径")
...
;; 一些Emacs的小设置
(require 'misc-settings) ;; scatch 的提示文字消失
...
;; 矩形区域操作
(require 'rect-mark-settings)           ; M-w
...
;; 字体配置
(require 'font-settings) ;; 窗口变大，字体变大
